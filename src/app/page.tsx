...
export default function Home() {
  ...
  return (
    <div style={{ background: '#000000', color: '#ffffff', fontFamily: '"IBM Plex Sans", system-ui, sans-serif', fontWeight: 300, overflowX: 'hidden' }}>
      
      {/* Sticky Navigation Bar */}
      <div id="nav" style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 90, background: 'rgba(0,0,0,0.92)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #262624', padding: '16px 5vw', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '24px', transition: 'padding .35s ease' }}>
        ...
        <div className="nav-desktop-links" style={{ display: 'flex', gap: 'clamp(16px, 2.4vw, 34px)', fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', letterSpacing: '0.16em', textTransform: 'uppercase', color: '#d4af37' }}>
        ...
        <button 
          ...
          style={{ display: 'none', background: 'none', border: 'none', color: '#ffffff', cursor: 'pointer', padding: '4px', zIndex: 101 }}
        >
        ...
        <div id="progress" style={{ position: 'absolute', left: 0, bottom: '-1px', height: '1px', width: '0%', background: '#d4af37', transition: 'width 0.1s ease' }}></div>
      </div>

      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="mobile-menu-overlay" style={{ position: 'fixed', top: '53px', left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.98)', backdropFilter: 'blur(16px)', zIndex: 85, display: 'flex', flexDirection: 'column', padding: '40px 8vw', gap: '28px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '16px', letterSpacing: '0.18em', textTransform: 'uppercase', borderTop: '1px solid #262624', animation: 'fadeIn 0.2s ease forwards' }}>
          <a href="#about" onClick={() => setIsMobileMenuOpen(false)} style={{ color: '#d4af37' }}>About</a>
          <a href="#expertise" onClick={() => setIsMobileMenuOpen(false)} style={{ color: '#d4af37' }}>Expertise</a>
          <a href="#frameworks" onClick={() => setIsMobileMenuOpen(false)} style={{ color: '#d4af37' }}>Frameworks</a>
          <a href="#work" onClick={() => setIsMobileMenuOpen(false)} style={{ color: '#d4af37' }}>Case Studies</a>
          <a href="#contact" onClick={() => setIsMobileMenuOpen(false)} style={{ color: '#d4af37' }}>Contact</a>
        </div>
      )}
      ...
      <section id="top" style={{ position: 'relative', padding: 'clamp(56px, 9vw, 132px) 5vw clamp(48px, 6vw, 96px)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(330px, 1fr))', gap: 'clamp(40px, 6vw, 88px)', alignItems: 'end', maxWidth: '1600px', margin: '0 auto' }}>
        <div style={{ position: 'absolute', top: '-8%', left: '-6%', width: 'min(620px, 55vw)', aspectRatio: '1', borderRadius: '50%', background: 'radial-gradient(circle, rgba(212,175,55, 0.10), rgba(212,175,55, 0) 65%)', pointerEvents: 'none', animation: 'glowPulse 12s ease-in-out infinite' }}></div>
        <div ref={(el) => { if (el) revealRefs.current[0] = el; }} style={{ position: 'relative' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: 'clamp(26px, 3vw, 44px)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              <span style={{ width: '26px', height: '1px', background: '#d4af37' }}></span>
              <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27' }}>Retention Marketing Strategist</span>
            </div>
          </div>
          <h1 style={{ fontFamily: 'Newsreader, Georgia, serif', fontWeight: 400, fontSize: 'clamp(46px, 6.8vw, 108px)', lineHeight: 0.97, letterSpacing: '-0.028em', margin: 0, textWrap: 'pretty', maxWidth: '15em' }}>
            Turning one-time buyers into <em style={{ fontStyle: 'italic', color: '#f3e5ab' }}>repeat</em> customers.
          </h1>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(20px, 3vw, 44px)', marginTop: 'clamp(32px, 3.6vw, 52px)', paddingTop: 'clamp(22px, 2.4vw, 30px)', borderTop: '1px solid #262624' }}>
            <div style={{ minWidth: '90px' }}>
              ...
              <div style={{ marginTop: '8px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#8e8e88', maxWidth: '16ch' }}>Performance &amp; lifecycle</div>
            </div>
            <div style={{ minWidth: '90px' }}>
              ...
              <div style={{ marginTop: '8px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#8e8e88', maxWidth: '16ch' }}>D2C brands owned</div>
            </div>
            <div style={{ minWidth: '110px' }}>
              ...
              <div style={{ marginTop: '8px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#8e8e88', maxWidth: '18ch' }}>Returning customer rate</div>
            </div>
            <div style={{ minWidth: '90px' }}>
              ...
              <div style={{ marginTop: '8px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#8e8e88', maxWidth: '16ch' }}>Retention improvement</div>
            </div>
          </div>
          <p style={{ maxWidth: '46ch', margin: 'clamp(28px, 3vw, 40px) 0 0', fontSize: 'clamp(16px, 1.25vw, 19px)', lineHeight: 1.64, color: '#d4d4cd', textWrap: 'pretty' }}>
          ...
          <a href="#proof" className="explore-link" style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', marginTop: 'clamp(40px, 5vw, 72px)', fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#8c8c85' }}>
            <span>Scroll to explore</span>
            <span id="scrollcue" style={{ display: 'block', position: 'relative', width: '1px', height: '38px', background: '#22352d', overflow: 'hidden' }}>
              <span style={{ position: 'absolute', inset: 0, background: 'linear-gradient(#d4af37, transparent)', animation: 'cueSlide 2.4s ease-in-out infinite' }}></span>
            </span>
          </a>
        </div>
        ...
        <div ref={(el) => { if (el) revealRefs.current[1] = el; }} style={{ justifySelf: 'stretch', alignSelf: 'stretch', width: '100%', position: 'relative', minHeight: 'clamp(380px, 44vw, 620px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ position: 'absolute', top: '2%', left: '6%', width: '86%', aspectRatio: '1', borderRadius: '50%', background: 'radial-gradient(circle, rgba(212,175,55, 0.26), rgba(212,175,55, 0.06) 46%, rgba(212,175,55, 0) 70%)', filter: 'blur(2px)', animation: 'glowPulse 11s ease-in-out infinite', pointerEvents: 'none' }}></div>
          ...
          <div style={{ position: 'absolute', top: '16%', right: '8%', width: '26%', aspectRatio: '1', borderRadius: '50%', background: 'radial-gradient(circle, rgba(243,229,171, 0.20), rgba(243,229,171, 0) 70%)', animation: 'floatY 13s ease-in-out infinite', pointerEvents: 'none' }}></div>
          <div style={{ position: 'absolute', bottom: '14%', left: '2%', width: '18%', aspectRatio: '1', borderRadius: '50%', background: 'radial-gradient(circle, rgba(212,175,55, 0.22), rgba(212,175,55, 0) 70%)', animation: 'floatY 9s ease-in-out infinite reverse', pointerEvents: 'none' }}></div>
          <div style={{ position: 'relative', width: 'min(100%, 430px)' }}>
            ...
            <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', background: 'radial-gradient(110% 90% at 50% 40%, rgba(212,175,55, 0.10), rgba(0,0,0, 0.30) 70%, rgba(0,0,0, 0.85) 100%)', mixBlendMode: 'multiply' }}></div>
            <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', background: 'radial-gradient(60% 45% at 72% 16%, rgba(243,229,171, 0.18), rgba(243,229,171, 0) 60%)' }}></div>
          </div>
          <div style={{ position: 'absolute', bottom: '2%', left: '50%', transform: 'translateX(-50%)', display: 'flex', gap: '14px', flexWrap: 'wrap', justifyContent: 'center', fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#8c8c85', whiteSpace: 'nowrap' }}>
            <span>Vishnupriya</span><span style={{ color: '#c59b27' }}>Retention · Lifecycle · CRM</span>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '0 5vw clamp(56px, 7vw, 96px)', maxWidth: '1600px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'clamp(28px, 4vw, 64px)', alignItems: 'end' }}>
        <div ref={(el) => { if (el) revealRefs.current[2] = el; }} style={{ width: '100%', position: 'relative' }}>
          <div style={{ position: 'relative', background: '#0b0b0a', border: '1px solid #262624', padding: 'clamp(20px, 2.3vw, 30px)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap', fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#8e8e88' }}>
              <span>Cohort retention · illustrative</span><span style={{ color: '#c59b27' }}>Interactive</span>
            </div>
            <div style={{ minHeight: '34px', display: 'flex', alignItems: 'baseline', gap: '10px', margin: '16px 0 6px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', letterSpacing: '0.12em', color: '#8c8c85' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '56px 1fr', gap: '12px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#696962' }}>
                <span>Cohort</span>
              ...
              {rows.map((row, ri) => {
                const labelColor = ri === sel ? '#f3e5ab' : '#8c8c85';
                return (
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              color: v > 55 ? '#1a120c' : '#ffffff',
                              background: `rgba(212,175,55, ${a.toFixed(3)})`,
                              outline: isHov ? '1px solid #f3e5ab' : (ri === sel ? '1px solid rgba(243,229,171, 0.35)' : '1px solid transparent'),
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap', marginTop: '20px', paddingTop: '14px', borderTop: '1px solid #17261f', fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#8e8e88' }}>
              <span>Decay is a structure problem</span><span style={{ color: '#c59b27' }}>not a volume problem</span>
            </div>
          </div>
        </div>
        <div ref={(el) => { if (el) revealRefs.current[3] = el; }} style={{ maxWidth: '44ch', paddingBottom: 'clamp(8px, 2vw, 28px)' }}>
          <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.24em', textTransform: 'uppercase', color: '#c59b27', marginBottom: '18px' }}>
            How I read a brand
          </div>
          <p style={{ margin: 0, fontSize: 'clamp(15.5px, 1.15vw, 17.5px)', lineHeight: 1.68, color: '#d4d4cd' }}>
      ...
      {/* KPI stats section */}
      <section id="proof" style={{ background: '#0b0b0a', borderTop: '1px solid #262624', borderBottom: '1px solid #262624', padding: 'clamp(56px, 7vw, 104px) 5vw' }}>
        <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '18px', flexWrap: 'wrap', marginBottom: 'clamp(36px, 4.5vw, 64px)' }}>
            <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27' }}>The record so far</span>
            <span style={{ flex: 1, minWidth: '60px', height: '1px', background: '#262624' }}></span>
          </div>
          <div id="kpis" ref={kpisRef} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 'clamp(28px, 3.4vw, 52px)' }}>
            <div className="kpi-card">
              <div style={{ position: 'absolute', top: '-18px', left: '-14px', width: '130px', height: '130px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(212,175,55,0.16), rgba(212,175,55,0) 70%)', pointerEvents: 'none' }}></div>
              <div style={{ position: 'relative', fontFamily: 'Newsreader, Georgia, serif', fontSize: 'clamp(50px, 4.8vw, 82px)', lineHeight: 0.9, letterSpacing: '-0.03em' }}>
                <span className="num">{nYears}</span> <span style={{ fontSize: '0.36em', letterSpacing: '0.02em', color: '#8c8c85' }}>years</span>
              </div>
              <div style={{ marginTop: '16px', fontSize: '14px', lineHeight: 1.5, color: '#a6a6a0', maxWidth: '22ch' }}>
            ...
            <div style={{ position: 'relative', borderTop: '1px solid #d4af37', paddingTop: '20px', background: 'radial-gradient(120% 80% at 20% 0%, rgba(212,175,55,0.14), rgba(212,175,55,0) 70%)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '18px', flexWrap: 'wrap' }}>
                <div style={{ fontFamily: 'Newsreader, Georgia, serif', fontSize: 'clamp(38px, 3.6vw, 60px)', lineHeight: 0.9, letterSpacing: '-0.03em', color: '#8c8c85' }}>
                  14 <span style={{ color: '#c59b27' }}>→</span> <span className="num">{nReturn}%</span>
                </div>
                
                {/* SVG Ring */}
                <div style={{ position: 'relative', width: '74px', height: '74px', borderRadius: '50%', flex: '0 0 auto', background: `conic-gradient(#f3e5ab 0turn ${ringPct / 100}turn, rgba(212,175,55,0.14) ${ringPct / 100}turn 1turn)` }}>
                  <div style={{ position: 'absolute', inset: '7px', borderRadius: '50%', background: '#0b0b0a', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: '"IBM Plex Mono", monospace', fontSize: '13px', color: '#f3e5ab' }}>
                    {ringPct}%
                  </div>
                </div>
              </div>
              <div style={{ marginTop: '16px', fontSize: '14px', lineHeight: 1.5, color: '#d4d4cd', maxWidth: '24ch' }}>
            ...
            <div className="kpi-card">
              ...
              <div style={{ position: 'relative', fontFamily: 'Newsreader, Georgia, serif', fontSize: 'clamp(42px, 4.2vw, 70px)', lineHeight: 0.9, letterSpacing: '-0.03em' }}>
                <span className="num">M1</span> <span style={{ color: '#c59b27' }}>→</span> <span className="num">M2</span>
              </div>
              <div style={{ marginTop: '16px', fontSize: '14px', lineHeight: 1.5, color: '#a6a6a0', maxWidth: '24ch' }}>
      ...
      <section id="about" style={{ padding: 'clamp(72px, 9vw, 144px) 5vw', maxWidth: '1600px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'clamp(36px, 5vw, 80px)', alignItems: 'start' }}>
          <div ref={(el) => { if (el) revealRefs.current[4] = el; }}>
            <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27' }}>01 / The Journey</div>
          ...
          <div ref={(el) => { if (el) revealRefs.current[5] = el; }} style={{ display: 'flex', flexDirection: 'column', gap: '22px', fontSize: 'clamp(15.5px, 1.15vw, 17.5px)', lineHeight: 1.7, color: '#d4d4cd', maxWidth: '62ch' }}>
            <p style={{ margin: 0 }}>
              <span style={{ fontFamily: 'Newsreader, Georgia, serif', fontSize: '1.35em', lineHeight: 1, color: '#ffffff' }}>I started my career in SEO,</span> and a year in, I moved into retention marketing — not because I planned it, but because the problems were more interesting. My team was shifting focus toward retention, and I found myself drawn to the “why” behind customer behavior rather than just visibility metrics.
            </p>
            <p style={{ margin: 0 }}>
            ...
            <p style={{ margin: 0 }}>
              Today, I manage <mark style={{ background: 'rgba(212,175,55, 0.16)', color: '#f3e5ab', padding: '0 4px' }}>7+ D2C brand relationships</mark> end-to-end — across wellness, beauty, food, and streetwear — owning everything from lifecycle architecture to CRM implementation to client reporting.
            </p>
          </div>
        </div>

        <figure ref={(el) => { if (el) revealRefs.current[6] = el; }} style={{ margin: 'clamp(56px, 7vw, 104px) 0', borderTop: '1px solid #333330', borderBottom: '1px solid #333330', padding: 'clamp(32px, 4vw, 56px) 0' }}>
          <blockquote style={{ margin: 0, fontFamily: 'Newsreader, Georgia, serif', fontWeight: 400, fontStyle: 'italic', fontSize: 'clamp(30px, 4.7vw, 76px)', lineHeight: 1.06, letterSpacing: '-0.025em', maxWidth: '26ch', textWrap: 'pretty' }}>
            “I don’t treat retention as <span style={{ fontStyle: 'normal', color: '#c59b27' }}>send more emails</span>.”
          </blockquote>
        </figure>
        ...
        <div ref={(el) => { if (el) revealRefs.current[7] = el; }} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'clamp(32px, 4vw, 72px)', alignItems: 'start' }}>
          <div>
            <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#8e8e88', marginBottom: '18px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '26px 1fr', gap: '14px', padding: '15px 0', borderTop: '1px solid #262624', fontSize: '16px', color: '#d4d4cd' }}>
              <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', color: '#c59b27' }}>A</span><span>A deliverability issue?</span>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '26px 1fr', gap: '14px', padding: '15px 0', borderTop: '1px solid #262624', fontSize: '16px', color: '#d4d4cd' }}>
              <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', color: '#c59b27' }}>B</span><span>A funnel leak?</span>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '26px 1fr', gap: '14px', padding: '15px 0', borderTop: '1px solid #262624', fontSize: '16px', color: '#d4d4cd' }}>
              <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', color: '#c59b27' }}>C</span><span>A cohort-specific churn pattern?</span>
            </div>
            <div style={{ padding: '18px 0 0', borderTop: '1px solid #262624', fontFamily: 'Newsreader, Georgia, serif', fontStyle: 'italic', fontSize: '20px', color: '#f3e5ab' }}>
      ...
      <section style={{ padding: 'clamp(56px, 6vw, 96px) 5vw clamp(72px, 9vw, 132px)', maxWidth: '1600px', margin: '0 auto' }}>
        <div ref={(el) => { if (el) revealRefs.current[8] = el; }} style={{ display: 'flex', alignItems: 'baseline', gap: '20px', flexWrap: 'wrap', marginBottom: 'clamp(36px, 4.5vw, 64px)' }}>
          ...
          <div style={{ flex: 1, minWidth: '60px', height: '1px', background: '#262624' }}></div>
          <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#8e8e88' }}>
            Execution <span style={{ color: '#c59b27' }}>→</span> Ownership <span style={{ color: '#c59b27' }}>→</span> Strategy
          </div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 0 }}>
          {timeline.map((t, idx) => (
            <div key={idx} ref={(el) => { if (el) revealRefs.current[9 + idx] = el; }} className="timeline-card">
              <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#c59b27' }}>{t.stage}</div>
              ...
              <p style={{ margin: '0 0 18px', fontSize: '15px', lineHeight: 1.62, color: '#a6a6a0', maxWidth: '34ch' }}>{t.body}</p>
              <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#8e8e88' }}>{t.meta}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Expertise Section */}
      <section id="expertise" style={{ padding: 'clamp(72px, 9vw, 132px) 5vw', background: '#0b0b0a', borderTop: '1px solid #262624', borderBottom: '1px solid #262624' }}>
        <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
          <div ref={(el) => { if (el) revealRefs.current[12] = el; }} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'clamp(28px, 4vw, 72px)', alignItems: 'end', marginBottom: 'clamp(44px, 5.5vw, 80px)' }}>
            <div>
              <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27' }}>02 / What I Solve</div>
            ...
            <p style={{ margin: 0, fontSize: '16px', lineHeight: 1.66, color: '#ffffff', maxWidth: '44ch', justifySelf: 'end' }}>
          ...
          <div>
            {expertise.map((e, idx) => (
              <div key={idx} ref={(el) => { if (el) revealRefs.current[13 + idx] = el; }} className="expertise-row">
                <div style={{ flex: '0 0 34px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', letterSpacing: '0.1em', color: '#c59b27' }}>{e.n}</div>
                ...
                <p style={{ flex: '1 1 340px', minWidth: 0, margin: 0, fontSize: '15.5px', lineHeight: 1.64, color: '#ffffff', maxWidth: '52ch' }}>{e.body}</p>
              </div>
            ))}
            <div style={{ borderTop: '1px solid #333330' }}></div>
          </div>
        </div>
      </section>
      ...
      <section id="frameworks" style={{ padding: 'clamp(72px, 9vw, 132px) 5vw', maxWidth: '1600px', margin: '0 auto' }}>
        <div ref={(el) => { if (el) revealRefs.current[20] = el; }} style={{ maxWidth: '74ch' }}>
          <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27' }}>03 / How I Think</div>
          ...
          <p style={{ margin: 0, fontSize: 'clamp(16px, 1.2vw, 18px)', lineHeight: 1.66, color: '#d4d4cd', maxWidth: '60ch' }}>
        ...
        {/* Framework 1 */}
        <div ref={(el) => { if (el) revealRefs.current[21] = el; }} style={{ marginTop: 'clamp(56px, 7vw, 104px)', borderTop: '1px solid #333330', paddingTop: 'clamp(24px, 3vw, 40px)' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '18px', flexWrap: 'wrap' }}>
            <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#8e8e88' }}>Framework 01</span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(290px, 1fr))', gap: 'clamp(28px, 4vw, 64px)', marginTop: 'clamp(28px, 3.4vw, 48px)', alignItems: 'start' }}>
            <p style={{ margin: 0, fontSize: '16px', lineHeight: 1.68, color: '#d4d4cd', maxWidth: '48ch' }}>
              Separates what retention marketing actually controls — the stimulus layer — from the behavioral outcomes it is trying to influence. Used to establish whether an underperforming metric is a <em style={{ fontFamily: 'Newsreader, Georgia, serif', fontSize: '1.06em', color: '#f3e5ab' }}>strategy</em>, <em style={{ fontFamily: 'Newsreader, Georgia, serif', fontSize: '1.06em', color: '#f3e5ab' }}>execution</em> or <em style={{ fontFamily: 'Newsreader, Georgia, serif', fontSize: '1.06em', color: '#f3e5ab' }}>deliverability</em> problem — before building another flow.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
              <div style={{ border: '1px solid #333330', background: '#0b0b0a', padding: '18px 20px' }}>
                <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#c59b27', marginBottom: '14px' }}>Stimulus layer · controllable</div>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px 14px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '12px', letterSpacing: '0.06em', color: '#ffffff' }}>
                  <span>Flows</span><span style={{ color: '#474744' }}>·</span><span>Triggers</span><span style={{ color: '#474744' }}>·</span><span>Offers</span><span style={{ color: '#474744' }}>·</span><span>Timing</span><span style={{ color: '#474744' }}>·</span><span>Messaging</span><span style={{ color: '#474744' }}>·</span><span>Channels</span>
                </div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ width: '1px', height: '22px', background: '#333330' }}></div>
                <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#8e8e88', padding: '6px 0' }}>Customer behavior</div>
                <div style={{ width: '1px', height: '22px', background: '#333330' }}></div>
              </div>
              <div style={{ border: '1px solid #d4af37', background: 'linear-gradient(180deg, rgba(212,175,55, 0.1), rgba(212,175,55, 0.02))', padding: '18px 20px' }}>
                <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#f3e5ab', marginBottom: '14px' }}>Response layer · observed</div>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px 14px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '12px', letterSpacing: '0.06em', color: '#ffffff' }}>
        ...
        {/* Framework 2 */}
        <div ref={(el) => { if (el) revealRefs.current[22] = el; }} style={{ marginTop: 'clamp(56px, 7vw, 104px)', borderTop: '1px solid #333330', paddingTop: 'clamp(24px, 3vw, 40px)' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '18px', flexWrap: 'wrap' }}>
            <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#8e8e88' }}>Framework 02</span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(290px, 1fr))', gap: 'clamp(28px, 4vw, 64px)', marginTop: 'clamp(28px, 3.4vw, 48px)', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', borderLeft: '1px solid #d4af37', paddingLeft: 'clamp(20px, 2.4vw, 36px)' }}>
              {backbone.map((b, idx) => (
                <div key={idx} style={{ display: 'grid', gridTemplateColumns: '44px 1fr', gap: '16px', alignItems: 'baseline', padding: '18px 0', borderBottom: '1px solid #262624' }}>
                  <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '11px', color: '#c59b27' }}>{b.n}</div>
                  <div>
                    ...
                    <div style={{ marginTop: '8px', fontSize: '14.5px', lineHeight: 1.58, color: '#a6a6a0', maxWidth: '42ch' }}>{b.body}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* Framework 3 */}
        <div ref={(el) => { if (el) revealRefs.current[23] = el; }} style={{ marginTop: 'clamp(56px, 7vw, 104px)', borderTop: '1px solid #333330', paddingTop: 'clamp(24px, 3vw, 40px)' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '18px', flexWrap: 'wrap' }}>
            <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#8e8e88' }}>Framework 03</span>
          ...
          <p style={{ margin: 'clamp(22px, 2.6vw, 34px) 0 clamp(26px, 3vw, 40px)', fontSize: '16px', lineHeight: 1.68, color: '#d4d4cd', maxWidth: '66ch' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', borderTop: '1px solid #333330' }}>
            {kpiRows.map((k, idx) => (
              <div key={idx} className="kpi-row">
                <div style={{ flex: '1 1 220px', minWidth: 0 }}>
                  <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#8e8e88', marginBottom: '8px' }}>KPI</div>
                ...
                <div style={{ flex: '1 1 260px', minWidth: 0 }}>
                  <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#8e8e88', marginBottom: '8px' }}>Diagnosis</div>
                  <div style={{ fontSize: '14.5px', lineHeight: 1.58, color: '#ffffff' }}>{k.diagnosis}</div>
                </div>
                <div style={{ flex: '1 1 260px', minWidth: 0 }}>
                  <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#8e8e88', marginBottom: '8px' }}>Flow &amp; trigger</div>
                  <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '12px', lineHeight: 1.6, letterSpacing: '0.04em', color: '#c59b27' }}>{k.flow}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="work" style={{ padding: 'clamp(72px, 9vw, 132px) 5vw', background: '#0b0b0a', borderTop: '1px solid #262624', borderBottom: '1px solid #262624' }}>
        <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
          <div ref={(el) => { if (el) revealRefs.current[24] = el; }} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'clamp(28px, 4vw, 72px)', alignItems: 'end', marginBottom: 'clamp(40px, 5vw, 72px)' }}>
            <div>
              <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27' }}>04 / Selected Work</div>
              <h2 style={{ fontFamily: 'Newsreader, Georgia, serif', fontWeight: 400, fontSize: 'clamp(34px, 4.4vw, 70px)', lineHeight: 1.02, letterSpacing: '-0.025em', margin: '22px 0 0' }}>
            ...
            <div style={{ justifySelf: 'end', display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'flex-start' }}>
              <p style={{ margin: 0, fontSize: '15.5px', lineHeight: 1.64, color: '#a6a6a0', maxWidth: '40ch' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#8e8e88', flexWrap: 'wrap' }}>
                  <span>Problem</span><span style={{ color: '#d4af37' }}>→</span><span>Diagnostic</span><span style={{ color: '#d4af37' }}>→</span><span>Solution</span><span style={{ color: '#d4af37' }}>→</span><span style={{ color: '#f3e5ab' }}>Outcome</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(40px, 5vw, 76px)' }}>
            {cases.map((c, idx) => {
              const stages = [
                { n: '01', label: 'Problem', body: c.problem, track: '#333330', dot: '#696962', labelColor: '#ff6b6b', bg: 'rgba(255,255,255,0.012)', big: false, tag: false },
                { n: '02', label: 'Diagnostic', body: c.diagnostic, track: '#42423e', dot: '#8c8c85', labelColor: '#4fc3f7', bg: 'rgba(143,161,151,0.05)', big: false, tag: c.diagTag || false },
                { n: '03', label: 'Structured solution', body: c.solution, track: '#7a6b4d', dot: '#d4af37', labelColor: '#ffb74d', bg: 'rgba(212,175,55,0.07)', big: false, tag: c.solTag || false },
                { n: '04', label: 'Outcome', body: c.result, track: '#f3e5ab', dot: '#f3e5ab', labelColor: '#81c784', bg: 'radial-gradient(130% 100% at 15% 0%,rgba(212,175,55,0.17),rgba(212,175,55,0.02) 78%)', big: c.resultBig, tag: false }
              ];
              return (
                <div key={idx} ref={(el) => { if (el) revealRefs.current[25 + idx] = el; }} className="case" style={{ position: 'relative', borderTop: '1px solid #333330', paddingTop: 'clamp(26px, 3vw, 42px)' }}>
                  <div style={{ position: 'absolute', top: '-1px', left: 0, width: 'clamp(90px, 14vw, 190px)', height: '1px', background: 'linear-gradient(90deg, #d4af37, rgba(212,175,55, 0))' }}></div>

                  <div className="case-rail">
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '18px' }}>
                      <div style={{ position: 'relative', flex: '0 0 auto', width: '58px', height: '58px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'radial-gradient(circle, rgba(212,175,55, 0.22), rgba(212,175,55, 0.02) 70%)', border: '1px solid #333330' }}>
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px 14px', marginTop: '12px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#8e8e88' }}>
                          <span style={{ color: '#c59b27' }}>{c.industry}</span>
                          {c.brand && !c.brand.toLowerCase().includes('undisclosed') && !c.brand.toLowerCase().includes('withheld') && (
                            <>
                              <span style={{ color: '#474744' }}>·</span>
                              <span>{c.brand}</span>
                            </>
                          )}
                        </div>
                    ...
                    <div style={{ position: 'relative', marginTop: 'clamp(24px, 2.6vw, 34px)', padding: '22px 24px', border: '1px solid #5c4e3b', background: 'radial-gradient(130% 110% at 18% 0%, rgba(212,175,55, 0.15), rgba(212,175,55, 0) 78%)', overflow: 'hidden' }}>
                      <div style={{ position: 'absolute', top: '-40%', right: '-18%', width: '62%', aspectRatio: 1, borderRadius: '50%', background: 'radial-gradient(circle, rgba(243,229,171, 0.16), rgba(243,229,171, 0) 68%)', pointerEvents: 'none', animation: 'glowPulse 10s ease-in-out infinite' }}></div>
                      <div style={{ position: 'relative', fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.24em', textTransform: 'uppercase', color: '#8c8c85' }}>Headline result</div>
                    ...
                    <div style={{ marginTop: 'clamp(18px, 2vw, 26px)', padding: '20px 22px', borderLeft: '2px solid #d4af37', background: 'linear-gradient(90deg, rgba(212,175,55, 0.10), rgba(212,175,55, 0.01))' }}>
                      <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '9.5px', letterSpacing: '0.24em', textTransform: 'uppercase', color: '#c59b27', marginBottom: '12px' }}>Relevant if</div>
                      <p style={{ margin: 0, fontFamily: 'Newsreader, Georgia, serif', fontSize: 'clamp(18px, 1.5vw, 23px)', lineHeight: 1.45, letterSpacing: '-0.01em', color: '#ffffff', textWrap: 'pretty' }}>{c.relevant}</p>
                    </div>
                    ...
                    {stages.map((st, sIdx) => (
                      <div key={sIdx} className="step" style={{ position: 'relative', display: 'grid', gridTemplateColumns: '32px minmax(0, 1fr)', gap: 'clamp(14px, 1.6vw, 22px)', paddingBottom: 'clamp(22px, 2.4vw, 32px)' }}>
                        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '4px' }}>
                          <div style={{ width: '11px', height: '11px', borderRadius: '50%', background: st.dot, boxShadow: '0 0 0 5px rgba(212,175,55, 0.10)', flex: '0 0 auto' }}></div>
                          <div className="step-line" style={{ flex: 1, width: '1px', marginTop: '6px', background: `linear-gradient(180deg, ${st.track}, rgba(212,175,55, 0.10))` }}></div>
                        ...
                        <div style={{ minWidth: 0, padding: '2px 0 0' }}>
                          <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', flexWrap: 'wrap', marginBottom: '10px' }}>
                            ...
                            <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.16em', color: '#696962' }}>{st.n} / 04</span>
                          </div>
                          <p style={{ margin: 0, fontSize: 'clamp(15px, 1.12vw, 16.5px)', lineHeight: 1.7, color: '#ffffff', maxWidth: '62ch', textWrap: 'pretty' }}>{st.body}</p>
                          {st.tag && (
                            <div style={{ marginTop: '14px', display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: '"IBM Plex Mono", monospace', fontSize: '10px', letterSpacing: '0.16em', textTransform: 'uppercase', color: '#f3e5ab', background: 'rgba(212,175,55, 0.10)', border: '1px solid #5c4e3b', padding: '7px 12px' }}>{st.tag}</div>
                          )}
                          {st.big && (
      ...
      <section style={{ padding: 'clamp(72px, 9vw, 132px) 5vw', maxWidth: '1600px', margin: '0 auto' }}>
        <div ref={(el) => { if (el) revealRefs.current[32] = el; }} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'clamp(32px, 4.5vw, 80px)', alignItems: 'start' }}>
          <div>
            <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27' }}>05 / The Stack</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {stack.map((s, idx) => (
              <div key={idx} style={{ borderTop: '1px solid #262624', padding: 'clamp(18px, 2.2vw, 28px) 0' }}>
                <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#8e8e88', marginBottom: '12px' }}>{s.label}</div>
                <div style={{ fontFamily: 'Newsreader, Georgia, serif', fontSize: 'clamp(19px, 1.7vw, 26px)', lineHeight: 1.5, letterSpacing: '-0.01em', color: '#ffffff' }}>{s.items}</div>
              </div>
            ))}
            <div style={{ borderTop: '1px solid #333330' }}></div>
          </div>
      ...
      {/* Contact Section */}
      <section id="contact" style={{ background: '#0b0b0a', borderTop: '1px solid #262624', padding: 'clamp(80px, 10vw, 160px) 5vw' }}>
        <div style={{ maxWidth: '1600px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'clamp(36px, 5vw, 88px)', alignItems: 'end' }}>
          <div ref={(el) => { if (el) revealRefs.current[33] = el; }}>
            <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.26em', textTransform: 'uppercase', color: '#c59b27', marginBottom: 'clamp(26px, 3vw, 44px)' }}>Contact</div>
            <h2 style={{ fontFamily: 'Newsreader, Georgia, serif', fontWeight: 400, fontSize: 'clamp(36px, 5.4vw, 88px)', lineHeight: 1, letterSpacing: '-0.03em', margin: 0, maxWidth: '20ch', textWrap: 'pretty' }}>
              If customers aren’t coming back, <em style={{ fontStyle: 'italic', color: '#f3e5ab' }}>let’s find out why.</em>
            </h2>
          </div>
          <div ref={(el) => { if (el) revealRefs.current[34] = el; }} style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(28px, 3.4vw, 44px)', alignItems: 'flex-start' }}>
            <p style={{ margin: 0, fontSize: 'clamp(16px, 1.2vw, 18px)', lineHeight: 1.68, color: '#a6a6a0', maxWidth: '46ch' }}>
      ...
      {/* Footer Section */}
      <footer style={{ padding: 'clamp(32px, 4vw, 52px) 5vw', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '24px', alignItems: 'baseline', maxWidth: '1600px', margin: '0 auto', borderTop: '1px solid #262624' }}>
        <div>
          ...
          <div style={{ marginTop: '8px', fontSize: '13.5px', color: '#8e8e88' }}>Retention Marketing Strategist</div>
        </div>
        <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.16em', textTransform: 'uppercase', color: '#8e8e88' }}>
        ...
        <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: '10.5px', letterSpacing: '0.14em', color: '#696962', justifySelf: 'end' }}>
          © 2026 Vishnupriya
        </div>
      </footer>
          ...
          <div className="modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            {!formSubmitted ? (
              ...
              <div className="success-container">
                ...
                <p style={{ fontSize: '15px', color: '#a6a6a0', lineHeight: '1.6', maxWidth: '30ch', margin: '0 auto' }}>
